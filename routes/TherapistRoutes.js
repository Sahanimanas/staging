...
router.post("/filter",TherapistTokenMiddleware,getTherapists);
...
router.get('/getalltherapists',TherapistTokenMiddleware,require('../controller/therapistController/GetTherapist/therapis(accept=true).js'));
...
router.get('/availability/:id',TherapistTokenMiddleware , require('../controller/therapistController/schedule/getAvailabilityById.js'));
...
router.get("/dashboard/:therapistId",TherapistTokenMiddleware ,require('../controller/therapistController/Dashboard/dashboard.js'));
router.post('/bookings/revenue', TherapistTokenMiddleware ,require('../controller/therapistController/Dashboard/revenue.js'));
router.post("/reset", TherapistTokenMiddleware , require('../models/middlewares/verifyTherapist.js'), require('../controller/therapistController/schedule/DeleteEntireMonth.js'));
router.post('/next7days', TherapistTokenMiddleware ,require('../controller/therapistController/schedule/next7days.js'));
router.get('/filter',TherapistTokenMiddleware, require('../controller/therapistController/GetTherapist/getbypostalcode.js'));
//by Therapist flow
router.get('/list',TherapistTokenMiddleware, require('../controller/therapistController/GetTherapist/bytherpist/getTherapist.js'));
router.get('/:therapistId/services', TherapistTokenMiddleware ,require('../controller/services/therapistServices.js'));
//profile 
